...
Java_com_cteam_houston_input_NativeGamepad_init(JNIEnv *env, jobject this) {
...
JNIEXPORT void JNICALL
Java_com_cteam_houston_input_NativeGamepad_shutdown(JNIEnv *env, jobject this) {
	Gamepad_shutdown();
...
Java_com_cteam_houston_input_NativeGamepad_numDevices(JNIEnv *env, jobject this) {
	return Gamepad_numDevices();
}

// This triggers device detection
JNIEXPORT void JNICALL
Java_com_cteam_houston_input_NativeGamepad_detectDevices(JNIEnv *env, jobject this) {
	Gamepad_detectDevices();
}

// This polls for events and calls the appropriate callbacks
JNIEXPORT void JNICALL
Java_com_cteam_houston_input_NativeGamepad_processEvents(JNIEnv *env, jobject this) {
...
JNI_OnLoad(JavaVM *pjvm, void *reserved) {
	...
	nativeGamepadClass = (*env)->NewGlobalRef(env, (*env)->FindClass(env, "com/cteam/houston/input/NativeGamepad"));
